  ...
  return (
    <>
      ...
      <form>
        ...
        <div className="flex items-center gap-3 mb-4 md:mb-8 lg:mb-4 xl:mb-8">
          <input type="checkbox" name="remember_token" id="remember_token" />
          <label htmlFor="remember_token">Remember Password</label>
        </div>
        ...
        <p className="text-center mt-3">Don't have an account? <Link to="/register" className="underline text-[var(--blue-200)]">Create Account</Link></p>
      </form>
    </>
  );
}